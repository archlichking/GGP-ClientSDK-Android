...
public class Achievement_StepDefinitions extends BasicStepDefinition {
    ...
    public void verifyAchievementInfo(String achiName, String statusMark, int score) {
        ...
        assertEquals("lock status of achievement " + achiName, lockStatus, achi.isUnlocked());
    ...
    public void updateStatusAsCondition(String achiName, String statusMark) {
        ...
        Log.i(TAG, "Expect status of achievement " + achiName + " is " + statusMark);
    ...
    public void updateLockStatusByName(String achiName, String statusMark) {
        ...
        Log.i(TAG, "Got the achievement " + achiName + ", and update its status to : " + statusMark);
        updateLockStatus(achi, expectStatus);
    }
