...
//    	boolean isRooted = (Boolean) getBlockRepo().get(IS_ROOTED);
    	...
    	assertTrue("isRooted should be " + shouldBeRooted, shouldBeRootedFlag == DeviceInfo.isRooted());
    }
...
//    	boolean isSendableAndroidId = (Boolean) getBlockRepo().get(IS_SENDABLEANDROIDID);
    	...
    	assertTrue("isSendableAndroidId should be " + shouldBeSendableAndroidId, shouldBeSendableAndroidIdFlag == DeviceInfo.isSendableAndroidId());
    }
...
//    	boolean isSendableMacAddress = (Boolean) getBlockRepo().get(IS_SENDABLEMACADDRESS);
    	...
    	assertTrue("isSendableAndroidId should be " + shouldBeSendableMacAddress, shouldBeSendableMacAddressFlag == DeviceInfo.isSendableMacAddress());
    }
}
